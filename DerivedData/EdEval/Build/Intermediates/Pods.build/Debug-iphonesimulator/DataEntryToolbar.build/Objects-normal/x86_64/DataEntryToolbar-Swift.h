...
/**
  A subclass of \code
  UIToolbar
  \endcode intended for use as the input accessory view of a keyboard or picker, providing Next, Previous, & Done buttons to navigate up and down a dynamic tableView.
  To set up:
  - Set a DataEntryToolbar instance as the inputAccessoryView of textFields you want to control
  - Add textFields to \code
  tableTextFields
  \endcode in cellForRowAtIndexPath, using the textField’s cell’s indexPath as a key
...
/**
  A button for navigating backwards/upwards through textFields in \code
  tableView
  \endcode’s cells.
*/
@property (nonatomic, strong) UIBarButtonItem * _Null_unspecified previousButton;
/**
  A button for navigating forwards/downwards through textFields in \code
  tableView
  \endcode’s cells.
*/
...
/**
  A button used to resign firstResponder status on the active textField contained in a \code
  tableView
  \endcode’s cell.
*/
...
/**
  A dictionary containing textFields in \code
  tableView
  \endcode, identified by the containing cell’s index path.
*/
